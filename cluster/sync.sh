...
IMAGE_REGISTRY=${registry} make manager push-manager
...
sed 's#REPLACE_IMAGE#registry:5000/nmstate/kubernetes-nmstate-manager#' deploy/operator.yaml | ./cluster/kubectl.sh apply -f -
