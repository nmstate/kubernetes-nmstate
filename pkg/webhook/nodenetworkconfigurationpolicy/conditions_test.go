...
func expectConditionsUnknown(policy nmstatev1beta1.NodeNetworkConfigurationPolicy) {
	numberOfConditionTypes := len(nmstatev1beta1.NodeNetworkConfigurationPolicyConditionTypes)
	...
	for _, conditionType := range nmstatev1beta1.NodeNetworkConfigurationPolicyConditionTypes {
		...
		ExpectWithOffset(1, condition.Reason).To(Equal(nmstatev1beta1.ConditionReason("")))
