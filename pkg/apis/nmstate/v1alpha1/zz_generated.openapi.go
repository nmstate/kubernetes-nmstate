...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"./pkg/apis/nmstate/v1alpha1.NodeNetworkConfigurationEnactmentSpec":   schema_pkg_apis_nmstate_v1alpha1_NodeNetworkConfigurationEnactmentSpec(ref),
...
func schema_pkg_apis_nmstate_v1alpha1_NodeNetworkConfigurationEnactment(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/nmstate/v1alpha1.NodeNetworkConfigurationEnactmentSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"./pkg/apis/nmstate/v1alpha1.NodeNetworkConfigurationEnactmentSpec", "./pkg/apis/nmstate/v1alpha1.NodeNetworkConfigurationEnactmentStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_nmstate_v1alpha1_NodeNetworkConfigurationEnactmentSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NodeNetworkConfigurationEnactmentSpec defines the desired state of NodeNetworkConfigurationEnactment",
				Type:        []string{"object"},
			},
		},
	}
