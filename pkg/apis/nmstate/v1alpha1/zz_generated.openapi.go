...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"./pkg/apis/nmstate/v1alpha1.PolicyEnactment":                         schema_pkg_apis_nmstate_v1alpha1_PolicyEnactment(ref),
...
func schema_pkg_apis_nmstate_v1alpha1_NodeNetworkConfigurationPolicyStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"enactments": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("./pkg/apis/nmstate/v1alpha1.PolicyEnactment"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"./pkg/apis/nmstate/v1alpha1.PolicyEnactment"},
	}
}
...
func schema_pkg_apis_nmstate_v1alpha1_PolicyEnactment(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"Ref": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/nmstate/v1alpha1.NodeNetworkConfigurationEnactment"),
						},
					},
				},
				Required: []string{"Ref"},
		...
		Dependencies: []string{
			"./pkg/apis/nmstate/v1alpha1.NodeNetworkConfigurationEnactment"},
	}
}
