...
func (in *NodeNetworkConfigurationPolicyStatus) DeepCopyInto(out *NodeNetworkConfigurationPolicyStatus) {
	*out = *in
	if in.Enactments != nil {
		...
		*out = make(PolicyEnactmentList, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PolicyEnactment) DeepCopyInto(out *PolicyEnactment) {
	*out = *in
	if in.Ref != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PolicyEnactment.
func (in *PolicyEnactment) DeepCopy() *PolicyEnactment {
	if in == nil {
		return nil
	}
	out := new(PolicyEnactment)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in PolicyEnactmentList) DeepCopyInto(out *PolicyEnactmentList) {
	{
		in := &in
		*out = make(PolicyEnactmentList, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PolicyEnactmentList.
func (in PolicyEnactmentList) DeepCopy() PolicyEnactmentList {
	if in == nil {
		return nil
	}
	out := new(PolicyEnactmentList)
	in.DeepCopyInto(out)
	return *out
}
