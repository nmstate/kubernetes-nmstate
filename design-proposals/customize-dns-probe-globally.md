...
In some clusters, the network configuration is not compatible with the DNS health
probe of the kubernetes-nmstate cluster health probes, so the NNCPs will fail.
