...
NM_FUTURE_COPR_REPO=NetworkManager-1.30

ifeq ($(NMSTATE_PIN), future)
export NMSTATE_COPR_REPO=$(NMSTATE_FUTURE_COPR_REPO)
export NM_COPR_REPO=$(NM_FUTURE_COPR_REPO)
else
export NMSTATE_COPR_REPO=$(NMSTATE_CURRENT_COPR_REPO)
export NM_COPR_REPO=$(NM_CURRENT_COPR_REPO)
endif
