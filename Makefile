...
unit_test_args ?=  -r -keep-going --randomize-all --randomize-suites --race --trace --junit-report=unit-test-junit.xml $(UNIT_TEST_ARGS)
...
e2e_test_args = -v -timeout=$(E2E_TEST_TIMEOUT) --slow-spec-threshold=60m $(E2E_TEST_ARGS)
