...
The following GitHub secrets need to be configured in the repository:

- `NMSTATE_SLACK_CHANNEL_ID`: The ID of the Slack channel where messages will be posted
- `NMSTATE_REPORTER_SLACK_TOKEN`: The Slack bot token for authentication
...
export NMSTATE_REPORTER_SLACK_TOKEN="your-slack-token"
export NMSTATE_CHANNEL_ID="your-channel-id"
