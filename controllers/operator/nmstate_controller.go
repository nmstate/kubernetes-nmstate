...
func (r *NMStateReconciler) applyHandler(instance *nmstatev1.NMState) error {
	...
	verboseHandlerCommandArg := ""
	handlerReadinessProbeExtraArg := ""
	if instance.Spec.Verbose == shared.VerboseLevelDebug {
		verboseHandlerCommandArg = "debug"
	...
	data.Data["VerboseHandlerCommandArg"] = verboseHandlerCommandArg
