...
$(yq4) --inplace eval '.metadata.annotations += {"operators.openshift.io/valid-subscription": "false"}' ${BUNDLE_DIR}/manifests/kubernetes-nmstate-operator.clusterserviceversion.yaml
