...
type Interface struct {
	...
	Bond          *BondInterface        `json:",omitempty"`
	Dummy         *DummyInterface       `json:",omitempty"`
	Ethernet      *EthernetInterface    `json:",omitempty"`
	LinuxBridge   *LinuxBridgeInterface `json:",omitempty"`
	OvsBridge     *OvsBridgeInterface   `json:",omitempty"`
	OvsInterface  *OvsInterface         `json:",omitempty"`
	Unknown       *UnknownInterface     `json:",omitempty"`
	Vlan          *VlanInterface        `json:",omitempty"`
	Vxlan         *VxlanInterface       `json:",omitempty"`
	MacVlan       *MacVlanInterface     `json:",omitempty"`
	MacVtap       *MacVtapInterface     `json:",omitempty"`
	Vrf           *VrfInterface         `json:",omitempty"`
	InfiniBand    *InfiniBandInterface  `json:",omitempty"`
	Loopback      *LoopbackInterface    `json:",omitempty"`
}
...
// +k8s:deepcopy-gen=true
type MergedDnsState struct {
	Desired  *DnsState `json:"desired"`
	Current  *DnsState `json:"current"`
...
// +k8s:deepcopy-gen=true
type MergedRouteRules struct {
	Desired   *RouteRules      `json:"desired"`
	Current   *RouteRules      `json:"current"`
	ForApply  []RouteRuleEntry `json:"for_apply"`
	ForVerify []RouteRuleEntry `json:"for_verify"`
}
...
// +k8s:deepcopy-gen=true
type MergedHostNameState struct {
	Desired *HostNameState `json:"desired,omitempty"`
	Current *HostNameState `json:"current,omitempty"`
}
...
type LinuxBridgeInterface struct {
	Bridge *LinuxBridgeConfig `json:"linux-bridge,omitempty"`
}
...
type BridgePortVlanConfig struct {
	...
	TrunkTags    []BridgePortTunkTag `json:"trunk-tags,omitempty"`
}
...
type OvsBridgeInterface struct {
	Bridge *OvsBridgeConfig `json:"ovs-bridge,omitempty"`
}

// +k8s:deepcopy-gen=true
type OvsBridgeConfig struct {
	Options *OvsBridgeOptions     `json:"options,omitempty"`
	Ports   []OvsBridgePortConfig `json:"port,omitempty"`
}
...
type BaseInterface struct {
	...
	IfaceType             InterfaceType       `json:"type,omitempty"`
