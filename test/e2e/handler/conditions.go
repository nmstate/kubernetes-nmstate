...
func conditionsToYaml(conditions nmstatev1beta1.ConditionList) string {
...
func enactmentConditionsStatus(node string, policy string) nmstatev1beta1.ConditionList {
	enactment := nodeNetworkConfigurationEnactment(nmstatev1beta1.EnactmentKey(node, policy))
	obtainedConditions := nmstatev1beta1.ConditionList{}
	for _, enactmentsConditionType := range nmstatev1beta1.NodeNetworkConfigurationEnactmentConditionTypes {
		...
		obtainedConditions = append(obtainedConditions, nmstatev1beta1.Condition{
...
func enactmentConditionsStatusForPolicyEventually(node string, policy string) AsyncAssertion {
	return Eventually(func() nmstatev1beta1.ConditionList {
...
func enactmentConditionsStatusForPolicyConsistently(node string, policy string) AsyncAssertion {
	return Consistently(func() nmstatev1beta1.ConditionList {
		return enactmentConditionsStatus(node, policy)
...
func policyConditionsStatus(policyName string) nmstatev1beta1.ConditionList {
	policy := nodeNetworkConfigurationPolicy(policyName)
	obtainedConditions := nmstatev1beta1.ConditionList{}
	for _, policyConditionType := range nmstatev1beta1.NodeNetworkConfigurationPolicyConditionTypes {
...
func containPolicyAvailable() GomegaMatcher {
	return ContainElement(nmstatev1beta1.Condition{
		Type:   nmstatev1beta1.NodeNetworkConfigurationPolicyConditionAvailable,
...
func containPolicyDegraded() GomegaMatcher {
	return ContainElement(nmstatev1beta1.Condition{
		Type:   nmstatev1beta1.NodeNetworkConfigurationPolicyConditionDegraded,
		Status: corev1.ConditionTrue,
	})
}
