...
func ethernetNicsState(states map[string]string) nmstatev1beta1.State {
...
`)
	...
	return nmstatev1beta1.NewState(stringBuilder.String())
}
func ethernetNicsUp(nics ...string) nmstatev1beta1.State {
...
func linuxBrUp(bridgeName string) nmstatev1beta1.State {
...
func linuxBrAbsent(bridgeName string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
  - name: %s
    type: linux-bridge
    state: absent
...
func linuxBrUpNoPorts(bridgeName string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
  - name: %s
    type: linux-bridge
    state: up
...
func ovsBrAbsent(bridgeName string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
  - name: %s
    type: ovs-bridge
...
func ovsBrUp(bridgeName string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
  - name: %s
    type: ovs-bridge
    state: up
...
func ovsbBrWithInternalInterface(bridgeName string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
  - name: ovs0
    type: ovs-interface
    state: up
...
func ifaceUpWithStaticIP(iface string, ipAddress string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
    - name: %s
      type: ethernet
      state: up
...
func ifaceUpWithVlanUp(iface string, vlanId string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
    - name: %s.%s
      type: vlan
      state: up
...
func vlanAbsent(iface string, vlanId string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
    - name: %s.%s
      type: vlan
      state: absent
...
func interfaceAbsent(iface string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
    - name: %s
      state: absent
`, iface))
...
func ifaceDownIPv4Disabled(iface string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
    - name: %s
      type: ethernet
      state: down
...
func vlanUpWithStaticIP(iface string, ipAddress string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
    - name: %s
      type: vlan
      state: up
