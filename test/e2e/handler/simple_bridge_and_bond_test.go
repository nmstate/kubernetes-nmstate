...
func bondAbsent(bondName string) nmstatev1beta1.State {
...
func brAndBondAbsent(bridgeName string, bondName string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
  - name: %s
    type: linux-bridge
    state: absent
...
func bondUp(bondName string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
  - name: %s
    type: bond
    state: up
...
func brWithBondUp(bridgeName string, bondName string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
  - name: %s
    type: bond
    state: up
...
func bondUpWithEth1AndEth2(bondName string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
- name: %s
  type: bond
  state: up
...
func bondUpWithEth1Eth2AndVlan(bondName string) nmstatev1beta1.State {
	return nmstatev1beta1.NewState(fmt.Sprintf(`interfaces:
- name: %s
  type: bond
  state: up
