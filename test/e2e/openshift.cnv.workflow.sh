...
make test-e2e-handler E2E_TEST_TIMEOUT=${TIMEOUT} E2E_TEST_ARGS="--junit-output=junit.functest.xml -ginkgo.noColor -ginkgo.focus $focus" NAMESPACE=$NAMESPACE KUBECONFIG=$KUBECONFIG
